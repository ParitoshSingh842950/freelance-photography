...
const Adanna = () => {
  ...
  return (
    <div>
      <NewHeader />
      <h2 className="mt-[50px] text-center font-bold text-[3rem] md:text-[8rem] text-[arial]">
        Adanna Eleje
      </h2>
      <div className="flex justify-center">
        <div
          className="h-[50vh] md:h-[80vh] w-[300px] duration-[2s] hover:w-full flex justify-center"
          style={{ width: expand ? "100%" : "300px" }}
        >
          <img
      ...
      <div className="flex px-[10px] md:px-[200px] py-[50px] items-center flex-col md:flex-row">
        ...
        <div className="md:w-1/2">
          ...
          quod, quam mollitia ducimus voluptatem beatae ad dicta deleniti
          ...
          Maiores quos obcaecati incidunt tempore, rerum laboriosam porro magni
          inventore necessitatibus, similique nobis reiciendis.
        </div>
      </div>
    </div>
  );
